...
export default function BlogPage() {
  ...
  const calculateReadingTime = (excerpt: string) => {
    ...
    const wordCount = excerpt.split(' ').length * 3; // Estimate based on excerpt
      ...
      <section className="pt-32 pb-6 px-6 md:px-12">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="font-extralight mb-6 leading-tight" style={{fontFamily: 'var(--font-gowun-batang)', fontSize: '51px', letterSpacing: '-2px', color: '#09090A'}}>
            Insights & <span style={{color: '#D959B3'}}>Stories</span><br />
            From Fig.1
          </h1>
          <p className="text-base mb-6 max-w-3xl mx-auto leading-tight" style={{color: '#777777', fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', fontWeight: 400}}>
            Discover our latest thoughts on AI innovation, advertising trends, and the future of digital experiences. Stay ahead with insights from our team of strategists, creatives, and technologists.
          </p>
        </div>
      </section>
      
      {/* Blog Posts Section */}
      <section className="pt-2 pb-8 px-6 md:px-12">
        <div className="max-w-7xl mx-auto">
          {error && (
            <div className="text-center py-12">
              ...
              <button 
                onClick={fetchPosts}
                className="bg-[#D959B3] text-white px-4 py-2 rounded-full text-sm font-medium"
              >
                Try Again
              </button>
            </div>
          ...
          {!error && posts.length > 0 && (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div key={post._id} className="flex flex-col h-full">
                <Link href={`/blog/${post.slug}`} className="block mb-4 group">
                  <div className="relative overflow-hidden transition-transform duration-300 group-hover:scale-105" style={{borderRadius: '22px'}}>
                    {post.featuredImage ? (
                      <Image
                      ...
                      <div className="w-full h-64 bg-gradient-to-br from-[#D959B3] to-[#B8479E] flex items-center justify-center" style={{borderRadius: '22px'}}>
                        <div className="text-white text-4xl font-light" style={{fontFamily: 'var(--font-gowun-batang)'}}>
                          Fig.1
                        </div>
                      </div>
                    )}
                ...
                <div className="flex flex-col justify-between flex-1">
                  <div className="mb-4">
                    <h3 className="text-2xl font-medium mb-3 leading-tight" style={{fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', color: '#09090A'}}>
                      {post.title}
                    </h3>
                    <p className="leading-relaxed mb-2" style={{color: '#777777', lineHeight: '1.4', fontSize: '15px'}}>
                      {post.excerpt}
                    </p>
                    <div className="flex items-center text-sm mb-4" style={{color: '#D959B3'}}>
